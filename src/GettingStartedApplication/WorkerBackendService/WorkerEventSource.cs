...
namespace WorkerBackendService
{
    ...
    [EventSource(Name = "MyCompany-GettingStartedApplication-WorkerBackendService")]
    internal sealed class WorkerEventSource : EventSource
    {
        public static readonly WorkerEventSource Current = new WorkerEventSource();

        static WorkerEventSource()
        {
        ...
        private WorkerEventSource() : base()
        {
        }
